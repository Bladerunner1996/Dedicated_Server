...
void AShooterGameModeBase::OnMatchEnded()
{
	...
	UpdateLeaderboard(LeaderIds); // 继承自 ADS_MatchGameMode::UpdateLeaderboard, 调用 GameStatsManager 的 UpdateLeaderboard函数，发送HTTP请求更新排行榜。这里子类继承父类的protected函数，传数据给父类函数的私有成员
}
